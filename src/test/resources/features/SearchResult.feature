...
Feature: Data Table feature
  User Story: As a user, I should be able to login as librarian. When I go Users page table should contains fallowing columns
  Actions, UserID, Full Name, Email, Group, Status

  Scenario Outline: See all columns
    When User logins as a librarian with "<username>" "<password>"
    And User goes to Users tab
